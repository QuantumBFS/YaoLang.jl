...
YaoInterpreter(;zxcalculus::Bool=true) = YaoInterpreter(Core.Compiler.NativeInterpreter(), zxcalculus)
...
YaoOptimizationParams(interp::YaoInterpreter) = YaoOptimizationParams(OptimizationParams(interp), interp.zxcalculus)
